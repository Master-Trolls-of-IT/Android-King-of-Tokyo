...
fun getInitialsCards(view: View): List<Card> {
    ...
    val initialCard = Card(cardData[0].toInt(), cardData[1], view.resources.getIdentifier(cardData[2], "drawable", "com.example.kingoftokyo"), cardData[3], 0, cardData[4], cardData[5])
