...
fun getPredifinedCards(view: View): List<Card> {
    ...
    val cardList = predefinedCard.map {
        ...
        Card(cardData[0].toInt(), cardData[1], view.resources.getIdentifier(cardData[2], "drawable", "com.example.kingoftokyo"), cardData[3], cardData[4].toInt(), cardData[5], cardData[6])
    }
    return cardList
}